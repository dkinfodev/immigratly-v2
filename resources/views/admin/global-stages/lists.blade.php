...
<ol class="breadcrumb breadcrumb-no-gutter">
 ...
 <li class="breadcrumb-item active">Global Stages</li>
      ...
      <div class="row justify-content-between align-items-center flex-grow-1">
        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch"  type="text" class="form-control" placeholder="Search Profile" aria-label="Search Language">
            </div>
        </div>
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('global-stages/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
        ...
        <div class="col-sm-2">
          <a class="btn btn-primary float-right" href="{{ baseUrl('/global-stages/add') }}">
      ...
      <table id="tableList" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
        <thead class="thead-light">
          <tr>
            ...
            <th class="table-column-pl-0">Visa Service</th>
            <th>Action</th>
          </tr>
        </thead>
        <tbody>
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/global-stages/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
