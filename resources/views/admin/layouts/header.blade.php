                ...
                <div class="hs-sub-menu dropdown-menu" aria-labelledby="accountMegaMenu" style="min-width: 14rem;">
                  ...
                  <div class="hs-has-sub-menu nav-item">
                    ...
                    <div class="hs-sub-menu dropdown-menu" aria-labelledby="authenticationMegaMenu"
                      ...
                      <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#signupModal">Signup
                        Modal</a>
                      ...
                      <a class="navbar-dropdown-menu-promo-link active" href="index.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <p class="navbar-dropdown-menu-media-desc">Over 60 corporate, agency, portfolio, account and
                              many more pages.</p>
                          </div>
                        </div>
                      </a>
                      ...
                      <a class="navbar-dropdown-menu-promo-link " href="demo-real-estate/index.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <p class="navbar-dropdown-menu-media-desc">Find the latest homes for sale, real estate
                              market data.</p>
                          </div>
                        </div>
                      </a>
                      ...
                      <a class="navbar-dropdown-menu-promo-link " href="demo-jobs/index.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <p class="navbar-dropdown-menu-media-desc">Search millions of jobs online to find the next
                              step in your career.</p>
                          </div>
                        </div>
                      </a>
                      <!-- End Promo Link -->
                        ...
                        <div class="d-flex">
                          <div class="flex-shrink-0">
                            <span class="svg-icon svg-icon-sm text-primary">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.3" d="M20 5H4C3.4 5 3 5.4 3 6V17H21V6C21 5.4 20.6 5 20 5Z"
                                  fill="#035A4B" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                  ...
                                  fill="#035A4B" />
                                <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="8" y="6" width="8"
                                  height="10">
                                  <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M14.9167 6.83334H9.91666C9.18899 6.83334 8.66666 7.37744 8.66666 8.08334V13.9167C8.66666 14.6226 9.18899 15.1667 9.91666 15.1667H14.9167C15.1841 15.1667 15.3333 15.0112 15.3333 14.75V14.3333H10.3333C10.1032 14.3333 9.91665 14.1468 9.91665 13.9167C9.91665 13.6866 10.1032 13.5 10.3333 13.5H15.3333V7.25001C15.3333 6.9888 15.1841 6.83334 14.9167 6.83334Z"
                                    fill="white" />
                          ...
                          <div class="flex-grow-1 ms-3">
                            <span class="navbar-dropdown-menu-media-title">Course <span
                                class="badge bg-success rounded-pill ms-1">Hot</span></span>
                            <p class="navbar-dropdown-menu-media-desc">Learn on your schedule. An online learning and
                              teaching demo.</p>
                          </div>
                        </div>
                      </a>
                      ...
                      <a class="navbar-dropdown-menu-promo-link " href="demo-shop/index.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <p class="navbar-dropdown-menu-media-desc">Choose an online store &amp; get your business
                              online today!</p>
                          </div>
                        </div>
                      </a>
                      ...
                      <a class="navbar-dropdown-menu-promo-link " href="demo-app-marketplace/index.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <p class="navbar-dropdown-menu-media-desc">Find apps and integrates seamlessly with popular
                              apps.</p>
                          </div>
                        </div>
                      </a>
                      ...
                      <a class="navbar-dropdown-menu-promo-link " href="demo-help-desk/index.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <p class="navbar-dropdown-menu-media-desc">A customer service demo that helps you balance
                              customer needs.</p>
                          </div>
                        </div>
                      </a>
                  ...
                  <a class="navbar-dropdown-menu-media-link" href="documentation/index.html">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="navbar-dropdown-menu-media-desc">Development guides for building projects with Space
                        </p>
                      </div>
                    </div>
                  </a>
            ...
            <div class="col">
              <div class="post-category ">
                <span href="#" class="text-reset text-user-title-type" rel="category"
                  style="color: #343f52 !important;/* background: #343f52; */padding: 0;font-size: 12px;display: inline-block;margin-bottom: 0.2rem;border-radius: 1rem;/* border: 1px solid rgba(164, 174, 198, 0.2); */">{{Auth::user()->role}}
                  Dashboard</span>
              </div>
                                                ...
                                                <ul class="list-group list-group-flush navbar-card-list-group">
                                                    ...
                                                    <li class="list-group-item custom-checkbox-list-wrapper">
                                                        <div class="row">
                                                            ...
                                                            <div class="col ml-n3">
                                                                <span
                                                                    class="card-title h5">{{$notification->title}}</span>
                                                                <p class="card-text font-size-sm">
                                                                    {{$notification->comment}} <span
                                                                        class="badge badge-success">Review</span></p>
                                                            </div>
                                                            <small
                                                                class="col-auto text-muted text-cap">{{dateFormat($notification->created_at)}}</small>
                                                        </div>
                                                        @if($notification->url != '')
                                                        <a class="stretched-link"
                                                            href="{{url('/view-notification/'.base64_encode($notification->id))}}"></a>
                                                        @endif
                                                    </li>
                       ...
                       "type": "css-animation"
                                ...
                                <div id="accountNavbarDropdown"
                                    ...
                                    <div class="dropdown-item-text">
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-sm avatar-circle mr-2">
                                                <img class="avatar-img" src="{{ professionalProfile() }}"
                                                    alt="Image Description">
                                            </div>
                                            <div class="media-body">
                                                <span
                                                    class="card-title h5">{{ Auth::user()->first_name." ".Auth::user()->last_name }}</span>
                                                <span class="card-text">{{Auth::user()->email}}</span>
                                            </div>
                                        </div>
                                    </div>
