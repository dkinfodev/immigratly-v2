          ...
          <div class="col-lg-10">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal mb-5">
              ...
              <ul class="nav nav-tabs align-items-center">
                ...
                <li class="nav-item">
                  <a class="nav-link " href="user-profile-teams.html">Articles</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="user-profile-projects.html">Events <span class="badge badge-soft-dark rounded-circle ml-1">3</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="user-profile-connections.html">Services</a>
                </li>
