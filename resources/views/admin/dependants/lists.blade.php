  ...
  <div class="page-header">
    <div class="row align-items-end">
      <div class="col-sm mb-2 mb-sm-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-no-gutter">
            ...
            <li class="breadcrumb-item active" aria-current="page">Dependants</li>
          </ol>
        </nav>
      ...
      <div class="col-sm-auto">
        <a class="btn btn-primary" href="{{ baseUrl('leads/dependants/'.$client_id.'/add') }}">
        ...
        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search Dependants" aria-label="Search Dependants">
            </div>
            <!-- End Search -->
          </form>
        </div>
        ...
        <table id="tableList" class="table table-borderless">
          <thead class="thead-light">
            <tr>
              ...
              <th scope="col" class="table-column-pl-0">Family Name</th>
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/leads/dependants/{{$client_id}}/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
