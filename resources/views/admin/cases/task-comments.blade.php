...
<li class="step-item">
  <div class="step-content-wrapper">
    <div class="step-avatar">
      ...
      @elseif($comment->user_type == 'professional')
      <img class="step-avatar-img" src="{{ professionalProfile($comment->send_by,'m') }}" alt="Image Description">
      @else
    ...
    <div class="step-content">
      <h5 class="mb-1">
        @if($comment->user_type == 'user')
        <?php $user = userDetail($comment->send_by); ?>
      ...
      <ul class="list-group">
        <!-- List Item -->
        @if(file_exists(professionalDir().'/cases/tasks/'.$comment->file_name) && $comment->file_name != '')
        <li class="list-group-item list-group-item-light">
          <a href="{{professionalDirUrl($subdomain).'/cases/tasks/'.$comment->file_name}}" download>
          <div class="row gx-1">
            <div class="col">
              <div class="media">
