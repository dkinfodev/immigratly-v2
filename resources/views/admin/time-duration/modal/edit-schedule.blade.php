<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body imm-education-modal-body">
      <form method="post" id="popup-form" class="js-validate" action="{{ baseUrl('/time-duration/update/'.base64_encode($record->id)) }}">  
          @csrf
          <!-- Form Group -->
          ...
          <div class="row form-group js-form-message">
            ...
            <select class="form-control @error('type') is-invalid @enderror" name="type" id="type">
              ...
              <option <?php if($record->type=="minutes"){echo "selected"; } ?> value="minutes">Minutes</option>
              <option <?php if($record->type=="hours"){echo "selected"; } ?> value="hours">Hours</option>
            </select>
