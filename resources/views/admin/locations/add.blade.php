...
<a class="btn btn-primary" href="{{ baseUrl('/locations') }}">
...
<div class="locations">
            ...
            <div class="col-sm mb-2 mb-sm-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-no-gutter">
                        ...
                        <!-- <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ baseUrl('/locations') }}">Working Schedules</a></li> -->
                        <li class="breadcrumb-item active" aria-current="page">{{$pageTitle}}</li>
                    </ol>
                </nav>
    ...
    <div class="card">
        <div class="card-body">
            <form id="form" class="js-validate" action="{{ baseUrl('locations/save') }}" method="post">
                @csrf
