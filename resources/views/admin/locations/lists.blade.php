  ...
  <div class="card">
    ...
    <div class="card-header">
      <div class="row justify-content-between align-items-center flex-grow-1">
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('locations/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
        ...
        <div class="col-sm-3">
          <a class="btn btn-primary float-right" onclick="showPopup('<?php echo baseUrl('locations/add') ?>')" href="javascript:;">
            Add Location
          </a>
        </div>
...
function loadData(page=1){
  var search = $("#datatableSearch").val();
    $.ajax({
        type: "POST",
        url: BASEURL + '/locations/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
...
function confirmDelete(e){
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
            type: "POST",
            url: BASEURL + '/locations/delete/'+id,
            data:{
                _token:csrf_token,
                user_id:id,
            },
...
function changeStatus(e){
  ...
  if($(e).is(":checked")){
    $.ajax({
        type: "POST",
        url: BASEURL + '/locations/status/active',
        data:{
            _token:csrf_token,
            id:id,
        },
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/locations/status/inactive',
        data:{
            _token:csrf_token,
            id:id,
        },
