<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body imm-education-modal-body">
      <form method="post" id="popup-form" class="js-validate" action="{{ baseUrl('primary-degree/update') }}">  
          @csrf
          <!-- Form Group -->
          ...
          <div class="row form-group js-form-message">
            ...
            <div class="col-sm-9">
              <div class="input-group input-group-sm-down-break">
                <input type="text" class="form-control @error('level') is-invalid @enderror" name="level" id="level" value="{{ $record->level }}" placeholder="Enter level" aria-label="Enter level" >
                @error('level')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
