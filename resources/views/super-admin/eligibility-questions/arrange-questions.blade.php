...
<div class="eligibility_questions">
  ...
  <!-- End Page Header -->
  <p class="text-danger">*Drag the questions to rearrage</p>
  <!-- Card -->
  <div class="card">
    <!-- Table -->
    <div class="table-responsive datatable-custom">
      <form id="form" action="{{ baseUrl('/visa-services/eligibility-questions/'.base64_encode($visa_service->id).'/arrange-questions') }}">
        @csrf
      <ul id="sortable">
        @foreach($question_sequence as $record)
          <li class="ui-state-default">
            ...
            <input type="hidden" name="question_id[]" value="{{$record->Question->unique_id}}" />
          </li>
        @endforeach
      </ul>
      </form>
