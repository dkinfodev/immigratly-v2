          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('visa-services/eligibility-questions/'.$visa_service_id.'/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
...
<!-- Modal -->
<form id="setEligibilityPatternForm" action="{{ baseUrl('visa-services/eligibility-questions/'.$visa_service_id.'/set-pattern') }}" method="post">
  @csrf
  <input type="hidden" id="question_ids" name="question_ids" />
</form>
<!-- End Modal -->
@endsection
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/visa-services/eligibility-questions/{{$visa_service_id}}/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
...
function setEligibilityPattern(){
  var ids = [];
  $(".row-checkbox:checked").each(function(){
      ids.push($(this).val());
  });
  $("#question_ids").val(ids.join(","));
  $("#setEligibilityPatternForm").submit();
}
</script>
@endsection