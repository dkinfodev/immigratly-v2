    ...
    <div class="card-header">
      <div class="row justify-content-between align-items-center flex-grow-1">
        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search Url" aria-label="Search ">
            </div>
            <!-- End Search -->
          </form>
        </div>
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('cron-urls/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
        ...
        <div class="col-sm-3">
          ...
          <a onclick="showPopup('{{ baseUrl('cron-urls/add') }}')" class="btn float-right btn-primary" href="javascript:;">
            <i class="tio-add mr-1"></i> Add Url
          </a>
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/cron-urls/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
