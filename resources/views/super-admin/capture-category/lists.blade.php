        ...
        <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search category" aria-label="Search ">
            </div>
            <!-- End Search -->
          </form>
        </div>
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('capture-category/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/capture-category/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
