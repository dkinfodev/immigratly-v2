                        ...
                        <div class="col-md-12">
                            ...
                            <div class="criteria">
                                ...
                                <div class="additional-section" data-index="<?php echo $index ?>" id="criteria_<?php echo $index ?>">
                                    <div class='col-md-12 text-right'><span onclick='removeCriteria(<?php echo $index ?>)' class='badge badge-danger criteria-remove'><i class='fa fa-times'></i></span></div>
                                    <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" value="<?php echo (!empty($additional_data))?$additional_data['language_requirement']['listening']:'' ?>" name="ads[<?php echo $index ?>][language_requirement][listening]" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Listening" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" value="<?php echo (!empty($additional_data))?$additional_data['language_requirement']['reading']:'' ?>" name="ads[<?php echo $index ?>][language_requirement][reading]" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Reading" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" value="<?php echo (!empty($additional_data))?$additional_data['language_requirement']['writing']:'' ?>" name="ads[<?php echo $index ?>][language_requirement][writing]" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Writing" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" value="<?php echo (!empty($additional_data))?$additional_data['language_requirement']['speaking']:'' ?>" name="ads[<?php echo $index ?>][language_requirement][speaking]" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Speaking" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control" name="ads[<?php echo $index ?>][testing_agency]">
                                                        ...
                                                        <option <?php echo (!empty($additional_data) && $additional_data['testing_agency'] == 'IELTS')?'selected':'' ?> value="IELTS">IELTS</option>
                                                        <option <?php echo (!empty($additional_data) && $additional_data['testing_agency'] == 'CELPIP')?'selected':'' ?> value="CELPIP">CELPIP</option>
                                                        <option <?php echo (!empty($additional_data) && $additional_data['testing_agency'] == 'TCF')?'selected':'' ?> value="TCF">TCF</option>
                                                        <option <?php echo (!empty($additional_data) && $additional_data['testing_agency'] == 'TEF')?'selected':'' ?> value="TEF">TEF</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input type="checkbox" <?php echo (isset($additional_data['exemption_canada_edu']) && $additional_data['exemption_canada_edu'] == '1')?'checked':'' ?> name="ads[<?php echo $index ?>][exemption_canada_edu]" value="1">
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group" id="noc_condition_<?php echo $index ?>" style="display:<?php echo (!empty($additional_data) && $additional_data['depend_on_noc'] == '1')?'block':'none' ?>">
                                                    <select class="form-control" <?php echo (!empty($additional_data) && $additional_data['depend_on_noc'] != '1')?'disabled':'' ?> requried name="ads[<?php echo $index ?>][noc]">
                                                        <option value="">Select Value</option>
                                                        <option <?php echo (!empty($additional_data) && $additional_data['noc'] == 'NOC A')?'selected':'' ?> value="NOC A">NOC A</option>
                                                        <option <?php echo (!empty($additional_data) && $additional_data['noc'] == 'NOC B')?'selected':'' ?> value="NOC B">NOC B</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <div id="ielts_points_<?php echo $index ?>" class="ip_index" data-index="<?php echo $index ?>" style="display:<?php echo (!empty($additional_data) && $additional_data['ielts_points'] == '1')?'block':'none' ?>">
                                                    <div class="ielts_points">
                                                        <?php
                                                            $ielts_points = array();
                                                            if(isset($additional_data['ielts_point']['listening'])){
                                                                $icount = count($additional_data['ielts_point']['listening']);
                                                                $ielts_points = $additional_data['ielts_point'];
                                                            }else{
                                                                $icount = 1;
                                                            }
                                                            for($j=0;$j < $icount;$j++){
                                                        ...
                                                        ?>
                                                        <div class="row ip_points" id="ip_<?php echo $index2 ?>" data-index="<?php echo $index2 ?>">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <input type="text" name="ads[<?php echo $index ?>][ielts_point][listening][]" value="<?php echo (!empty($ielts_points))?$ielts_points['listening'][$j]:"" ?>" <?php echo (empty($ielts_points))?"disabled":"" ?> requried data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Listening" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <input type="text" name="ads[<?php echo $index ?>][ielts_point][reading][]" value="<?php echo (!empty($ielts_points))?$ielts_points['reading'][$j]:"" ?>" <?php echo (empty($ielts_points))?"disabled":"" ?> required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Reading" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <input type="text" name="ads[<?php echo $index ?>][ielts_point][writing][]" value="<?php echo (!empty($ielts_points))?$ielts_points['writing'][$j]:"" ?>" <?php echo (empty($ielts_points))?"disabled":"" ?> required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Writing" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <input type="text" name="ads[<?php echo $index ?>][ielts_point][speaking][]" value="<?php echo (!empty($ielts_points))?$ielts_points['speaking'][$j]:"" ?>" <?php echo (empty($ielts_points))?"disabled":"" ?> required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Speaking" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <input type="text" name="ads[<?php echo $index ?>][ielts_point][points][]" value="<?php echo (!empty($ielts_points))?$ielts_points['points'][$j]:"" ?>" <?php echo (empty($ielts_points))?"disabled":"" ?> required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="The phone no field may only contain numeric characters." class="form-control" placeholder="Points" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php } ?>
                            ...
                            <a href="javascript:;" class="badge badge-danger pull-right" onclick="addmorecriteria(<?php echo $first_index ?>)"><i class="fa fa-plus"></i> Add Criteria</a>
...
function addmorepoints(e){
    var index = $(e).parents(".ip_index").data("index");
    var rand_no = Math.floor(Math.random() * 1000);
    var clone = $("#ielts_points_"+index+" .ielts_points .row:first-child").html();
    var html = "<div class='row ip_points' id='ip_"+rand_no+"'>";
...
function addmorecriteria(){
    var index = $(".criteria .additional-section:first-child").data("index");
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            setTimeout(function(){
                ...
                $("#criteria_"+rand_no).find("input,select,textarea").val('');
...
function removePoint(e){
    var length = $(e).parents(".ielts_points").find(".ip_points").length;
    if(length > 1){
        $(e).parents(".ip_points").remove();
    }else{
        errorMessage("Need atleast one points");
    }
}
function removeCriteria(id){
    var length = $(".criteria .additional-section").length;
    if(length > 1){
        $("#criteria_"+id).remove();
    }else{
