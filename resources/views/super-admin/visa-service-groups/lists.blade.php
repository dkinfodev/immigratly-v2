      ...
      <div class="row justify-content-between align-items-center flex-grow-1">
        <div class="col-sm-5 col-md-4 mb-3 mb-sm-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search Groups" aria-label="Search Groups">
            </div>
            <!-- End Search -->
          </form>
        </div>
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('visa-service-groups/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
        ...
        <div class="col-sm-2">
         <div class="col-sm-auto">
          <a class="btn btn-primary float-right" href="{{ baseUrl('/visa-service-groups/add') }}">
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/visa-service-groups/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
