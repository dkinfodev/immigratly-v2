...
<tr>
  ...
  <td> 
      ...
      <a href="{{baseUrl('employee-privileges/action/'.base64_encode($moduleId).'/edit/'.base64_encode($record->id))}}"><i class="tio-edit"></i></a> &nbsp; 
      <a href="javascript:;" onclick="confirmAction(this)" data-href="{{baseUrl('employee-privileges/action/delete/'.base64_encode($record->id))}}"><i class="tio-delete"></i></a> 
