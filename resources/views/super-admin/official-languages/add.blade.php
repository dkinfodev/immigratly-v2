...
<div class="content container-fluid">
  ...
  <div class="page-header">
    <div class="row align-items-end">
      <div class="col-sm mb-2 mb-sm-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-no-gutter">
            ...
            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ baseUrl('/official-languages') }}">Official Languages</a></li>
      ...
      <div class="col-sm-auto">
        <a class="btn btn-primary" href="{{baseUrl('official-languages')}}">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form id="languages-form" class="js-validate" action="{{ baseUrl('/official-languages/save') }}" method="post">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $(".add-btn").click(function(e){
        ...
        $.ajax({
          url:"{{ baseUrl('official-languages/save') }}",
          type:"post",
          data:formData,
          dataType:"json",
          beforeSend:function(){
