  ...
  <div class="card">
    ...
    <div class="card-header">
      <div class="row justify-content-between align-items-center flex-grow-1">
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('official-languages/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
        ...
        <div class="col-sm-2">
          <a class="btn btn-primary float-right" href="{{ baseUrl('/official-languages/add') }}">
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/official-languages/ajax-list?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
