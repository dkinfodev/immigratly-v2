...
<div class="user">
   ...
   <div class="card">
      <div class="card-body">
         <form id="form" class="js-validate" action="{{ baseUrl('user/update/'.base64_encode($record->id)) }}" method="post">
         @csrf
         ...
         <hr>
          <div class="col-md-6">
            <!-- Form Group -->
            <div class="row form-group">
              <label class="col-3 col-form-label input-label">Status</label>
                <div class="js-form-message">
