  ...
  <div class="page-header">
    <div class="row align-items-end">
      ...
      <div class="col-sm-auto">
        <a class="btn btn-primary" href="{{ baseUrl('/visa-services/cutoff/'.$visa_service_id.'/add') }}">
          ...
          <div class="d-sm-flex justify-content-sm-end align-items-sm-center">
            ...
            <div id="datatableCounterInfo" class="mr-2 mb-2 mb-sm-0" style="display: none;">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-sm btn-outline-danger" data-href="{{ baseUrl('visa-services/cutoff/'.$visa_service_id.'/delete-multiple') }}" onclick="deleteMultiple(this)" href="javascript:;">
      ...
      <table id="tableList" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
        <thead class="thead-light">
          <tr>
            ...
            <th class="table-column-pl-0">Points</th>
            <th>Action</th>
          </tr>
        </thead>
        <tbody>
...
function loadData(page=1){
    $.ajax({
        type: "POST",
        url: BASEURL + '/visa-services/cutoff/{{$visa_service_id}}/ajax-list?page='+page,
        data:{
            _token:csrf_token,
        },
        dataType:'json',
