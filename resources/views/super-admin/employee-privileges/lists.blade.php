  ...
  <div class="card">
    ...
    <div class="card-header">
      <div class="row justify-content-between align-items-center flex-grow-1">
        ...
        <div class="col-sm-2">
          <a class="btn btn-primary float-right" href="{{ baseUrl('/employee-privileges/add') }}">
...
function loadData(page=1){
    $.ajax({
        type: "POST",
        url: BASEURL + '/employee-privileges/ajax-list?page='+page,
        data:{
            _token:csrf_token
        },
        dataType:'json',
...
function search(keyword){
    $.ajax({
        type: "POST",
        url: BASEURL + '/employee-privileges/search/'+keyword,
        data:{
            _token:csrf_token
        },
        dataType:'json',
