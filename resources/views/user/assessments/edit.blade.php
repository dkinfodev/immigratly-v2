        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group js-form-message">
                    ...
                    <input type="text" id="assessment_title" value="{{ $record->assessment_title }}"
                        name="assessment_title" class="form-control" placeholder="Assessment Title">
                </div>
                ...
                @endif
                    ...
                    <input type="hidden" value="{{ (!empty($record->VisaService))?$record->visa_service_id:'' }}" name="visa_service_id" id="visa_service_id" />
                    <span id="visa_service" class="font-weight-bold">
                    @if(!empty($record->VisaService))
                        {{$record->VisaService->name}}
                    @endif
                    </span>
                    <!-- <select name="visa_service_id" id="visa_service" onchange="findProfessional()"
                ...
                <div class="form-group js-form-message">
                    ...
                    <select name="case_type" id="validationFormCaseTypeLabel" data-msg="Please select case type."
                        class="form-control">
