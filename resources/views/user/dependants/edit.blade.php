...
<div class="assessments">
    ...
    <!-- Card -->
    <form id="form" action="{{ baseUrl('dependants/update/'.base64_encode($record->id)) }}" class="js-validate" method="post">
        @csrf
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            ...
                            <input type="text" id="family_name" name="family_name" class="form-control" placeholder="Family Name" value="{{$record->family_name}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            <label class="input-label" for="given_name">Given Name</label>
                            <input type="text" id="given_name" name="given_name" class="form-control" placeholder="Given Name" value="{{$record->given_name}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="form-check form-check-inline">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customInlineRadio1" class="custom-control-input" name="other_name"
                                        value="yes"  {{ ($record->other_name == 'yes')?'checked':'' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customInlineRadio2"
                                        class="custom-control-input indeterminate-checkbox" name="other_name" value="no" {{ ($record->other_name == 'no')?'checked':'' }}>
                    ...
                    <div class="col-md-6 other_name">
                        <div class="form-group js-form-message">
                            ...
                            <input type="text" id="other_family_name" name="other_family_name" class="form-control" placeholder="Other Family Name" value="{{$record->other_family_name}}">
                        </div>
                    </div>
                    <div class="col-md-6 other_name">
                        <div class="form-group js-form-message">
                            <label class="input-label" for="other_given_name">Other Given Name</label>
                            <input type="text" id="other_given_name" name="other_given_name" class="form-control" placeholder="Other Given Name" value="{{$record->other_given_name}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group js-form-message">
                            ...
                            <div class="input-group">
                                <input type="text" autocomplete="off" name="date_of_birth" id="date_of_birth" class="form-control" placeholder="Date of Birth" aria-label="Date of birth"  data-msg="" value="{{$record->date_of_birth}}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            ...
                            <select name="country_of_birth" id="country_of_birth" data-msg="Please select gender."
                                ...
                                <option {{ ($record->country_of_birth == $country->id)?'selected':'' }} value="{{$country->id}}">{{$country->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            ...
                            <input type="text" id="passport_number" name="passport_number" class="form-control" placeholder="Passport Number" value="{{$record->passport_number}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            ...
                            <select name="passport_country" id="passport_country" data-msg="Please select country."
                                ...
                                <option value="">Select Country</option>
                                @foreach($countries as $country)
                                <option {{ ($record->passport_country == $country->id)?'selected':'' }} value="{{$country->id}}">{{$country->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            ...
                            <div class="input-group js-form-message">
                                <input type="text" autocomplete="off" name="issue_date" id="issue_date" class="form-control" placeholder="Issue Date" aria-label="Issue Date"  data-msg="" value="{{$record->issue_date}}">
                                <div class="input-group-addon p-2">
                                <i class="tio-date-range"></i>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group js-form-message">
                            ...
                            <div class="input-group js-form-message">
                                <input type="text" autocomplete="off" name="expiry_date" id="expiry_date" class="form-control" placeholder="Expiry Date" aria-label="Expiry Date"  data-msg="" value="{{$record->expiry_date}}">
                                <div class="input-group-addon p-2">
                                <i class="tio-date-range"></i>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group js-form-message">
                            ...
                            <input type="text" id="primary_phone_no" name="primary_phone_no" class="form-control" placeholder="Primary Phone Number" value="{{$record->primary_phone_no}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group js-form-message">
                            <label class="input-label" for="secondary_phone_no">Secondary Phone Number</label>
                            <input type="text" id="secondary_phone_no" name="secondary_phone_no" class="form-control" placeholder="Secondary Phone Number" value="{{$record->secondary_phone_no}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group js-form-message">
                            <label class="input-label" for="business_phone_no">Business Phone Number</label>
                            <input type="text" id="business_phone_no" name="business_phone_no" class="form-control" placeholder="Business Phone Number" value="{{$record->business_phone_no}}">
                        </div>
                    </div>
                </div>              
            </div>
    ...
    $(document).on('ready', function() {
        if($("input[name=other_name]:checked").val() == 'yes'){
            $(".other_name").show();
        }else{
            $(".other_name").hide();
        }
