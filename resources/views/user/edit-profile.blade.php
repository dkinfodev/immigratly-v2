      ...
      @endif
         ...
         <div class="row justify-content-md-between">
            ...
            <div class="col-md-7 justify-content-md-end">
               ...
               <!-- End Form Group -->
               <div class="row form-group">
                  <label for="validationFormUsernameLabel" class="col-form-label input-label">How can we identify you?</label>
                  <div class="col-12 pl-0">
                     <div class="js-form-message">
         ...
         <div class="row justify-content-md-between">
            <div class="col-md-6">
               ...
               <div class="row form-group">
                  ...
                  <div class="col-sm-7">
                     <div class="js-form-message">
                        <div class="form-control bg-light" id="validationFormEmailLabel" placeholder="Email">{{ $record->email }}</div>
                     </div>
                  </div>
               </div>
               <!-- End Form Group -->
