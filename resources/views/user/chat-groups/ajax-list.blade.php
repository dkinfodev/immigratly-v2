      ...
      <div class="col-auto">
        <div class="hs-unfold">
          ...
          <div id="action-{{$key}}" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-sm dropdown-menu-right">
            <a class="dropdown-item" href="{{baseUrl('chat-groups/edit/'.$record->unique_id)}}">Edit</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item text-danger" href="javascript:;" onclick="confirmAction(this)" data-href="{{baseUrl('chat-groups/delete/'.$record->unique_id)}}">Delete</a> 
          </div>
        </div>
      </div>
    </div>
