  ...
  <div class="page-header">
    <div class="row align-items-end">
      ...
      <div class="col-sm-auto">
        ...
        <a href="{{ baseUrl('/pay-now/'.$subdomain.'/'.$record['invoice']['unique_id']) }}" class="btn btn-warning">
          Pay Now
          <i class="tio-credit-card ml-1"></i>
        </a>
        @endif
        <a class="btn btn-primary" href="{{baseUrl('/cases/'.$subdomain.'/invoices/list/'.$case['unique_id'])}}">
      ...
      <div class="card card-lg">
        ...
        <div class="card-body">
          ...
          <div class="row justify-content-md-between">
            <div class="col-6 text-md-left mb-3">
              @if($record['invoice']['payment_status'] == 'paid')
              <div class="text-success"><i class="tio-checkmark-circle-outlined"></i> Payment Paid</div>
              <div class="text-danger"><i class="tio-calendar-month"></i> Paid on: {{dateFormat($record['invoice']['paid_date'],'F d, Y H:i:s a')}}</div>

              @else
              <span class="text-danger"><i class="tio-security-warning-outlined"></i> Payment Pending</span>
              @endif
            </div>
            <div class="col-6 text-md-right mb-3">
              <h2>Invoice #</h2>
          ...
          <div class="js-add-field"
            ...
            <div id="addInvoiceItemContainer">
              @foreach($record['invoice_items'] as $item)
              <?php
