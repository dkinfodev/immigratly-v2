    ...
    <div class="card-body">
     <!-- Step Form -->
      <form id="form" class="js-validate js-step-form"
         ...
         "isValidate": true
         }' action="{{baseUrl('my-cases/update')}}">
         @csrf
         <!-- Step -->
            ...
            <div id="createProjectStepDetails" class="active">
               ...
               <div class="form-group js-form-message">
                  ...
                  <div class="input-group input-group-merge">
                     ...
                     <input type="text" required data-msg="Please enter case title" class="form-control" name="case_title" id="case_title" placeholder="Enter case title here" aria-label="Enter case title here" value="{{$record->case_title}}">
                  </div>
               </div>
               <!-- End Form Group -->
            ...
            <div id="createProjectStepTerms" style="display: none;">
                              ...
                              <select name="visa_service_id" required data-msg="Please select visa service" id="visa_service_id" class="custom-select"
                                ...
                                @foreach($visa_services as $service)
                                  @if(!empty($service->name))
                                    <option <?php if($record->visa_service_id == $service->unique_id){ echo "selected"; } ?> data-price="{{$service->price}}" value="{{$service->unique_id}}">{{$service->name}}</option>
                                  @endif
                                @endforeach
                              </select>
                            </div>
               ...
               <div class="d-sm-flex align-items-center">
                  ...
                  <div class="d-flex justify-content-end ml-auto">
                     ...
                     <button id="createProjectFinishBtn" type="button" class="btn btn-primary">Save Case</button>
                  </div>
               </div>
               <!-- End Footer -->
            </div>
