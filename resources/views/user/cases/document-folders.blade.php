                        ...
                        <li class="list-group-item" data-foldername="{{$document['name']}}"
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    if(!empty($checkPin)){
                                ?>
                                <a title="Unpin Folder" href="javascript:;" onclick="unpinFolder(this)" data-foldertype="default" data-folderid="{{$document['unique_id']}}" data-pinid="{{$checkPin->id}}"
                                    class="btn btn-sm btn-info js-nav-tooltip-link"><i class="tio-pin"></i></a>
                                <?php }else{ ?>
                                <a title="Pin Folder" href="javascript:;" onclick="pinFolder(this)" data-foldertype="default" data-folderid="{{$document['unique_id']}}"
                                    class="btn btn-sm btn-primary js-nav-tooltip-link"><i class="tio-pin"></i></a>
                                <?php } ?>
    ...
    <div class="row">
        <div class="col-lg-9 mb-5 mb-lg-0">
            ...
            <div class="tab-content" id="connectionsTabContent">
                <div class="mb-2 text-right">
                    <a onclick="showPopup('{{ baseUrl('documents/add-folder') }}')" class="btn btn-outline-primary" href="javascript:;">
                        ...
                        <li class="list-group-item draggable document-folder" data-foldername="{{$document->name}}"
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    if(!empty($checkPin)){
                                ?>
                                <a title="Unpin Folder" href="javascript:;" onclick="unpinFolder(this)" data-foldertype="mydoc" data-folderid="{{$document['unique_id']}}" data-pinid="{{$checkPin->id}}"
                                    class="btn btn-sm btn-info js-nav-tooltip-link"><i class="tio-pin"></i></a>
                                <?php }else{ ?>
                                <a title="Pin Folder" href="javascript:;" onclick="pinFolder(this)" data-foldertype="mydoc" data-folderid="{{$document['unique_id']}}"
                                    class="btn btn-sm btn-primary js-nav-tooltip-link"><i class="tio-pin"></i></a>
                                <?php } ?>
                                    <!-- <a href="<?php echo baseUrl("cases/documents/other/".$subdomain."/".$case_id."/".$document['unique_id']) ?>" 
                                        class="btn btn-sm btn-warning js-nav-tooltip-link" data-toggle="tooltip"
        ...
        <div class="col-lg-3">
            <div class="folder-btn">
                <a class="btn btn-info w-100 mb-3" href="{{ baseUrl('cases/import-to-my-documents/'.$subdomain.'/'.$record['unique_id']) }}">
                Import to My Documents 
                </a>
                <a class="btn btn-primary w-100 mb-3" href="{{ baseUrl('cases/my-documents-exchanger/'.$subdomain.'/'.$record['unique_id']) }}">
                Export from My Documents 
                </a>
                <a class="btn btn-success w-100 mb-3" href="{{ baseUrl('cases/documents-exchanger/'.$subdomain.'/'.$record['unique_id']) }}">
                Documents Exchanger
                </a>
