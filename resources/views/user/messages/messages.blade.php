                ...
                <div class="col-12 col-lg-5 col-xl-5" style="border-right: 1px solid rgba(231, 234, 243, 0.7);">
                    ...
                    <div class="chat-list py-8 scrollbar-macosx">
                        ...
                        @if($message_type == 'all_messages')
                            ...
                            <?php 
                                $chat = (object)$chat;
                                $professional = professionalDetail($chat->subdomain);
                                $user = array();
                            ...
                            ?>
                            <div class="card  mb-2 chat-general-message" data-name="<?php echo $uname ?>">
                            @elseif($chat->message_type == 'case')
                            <?php 
                                $chat_users = $chat->chat_users;
                            ?>
                            <div class="card  mb-2 chat-panel-message" data-name="<?php echo $uname ?>">
                            @elseif($chat->message_type == 'document')
                            <?php 
                                $chat_users = $chat->chat_users;
                            ?>
                            <div class="card  mb-2 chat-document-message" data-name="<?php echo $uname ?>">
                            @else
                            <?php 
                                $chat_users = array();
                            ?>
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-circle">
                                                ...
                                                @else
                                                <img class="avatar-img" src="{{ professionalProfile($chat->created_by,'t',$chat->subdomain) }}" alt="Image Description">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col" style="padding:0"> <span
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php 
                                                    $fileicon = fileIcon($chat->file_detail['original_name']);
                                                    echo $fileicon;
                                                ?>
                                                <div class="text-msg text-dark">{{$chat->file_detail['original_name']}}</div>
                                                <div class="text-dark d-block">{{$chat->file_message}}</div>
                                                </a>
                                                @else
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            <h6 class="mb-1">{{$professional->company_name}}</h6>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-1">
                                                ...
                                                if($usr->send_by != 'client'){
                                                    $cuser = docChatSendBy($usr->send_by,$usr->created_by,$chat->subdomain);
                                                }else{
                                                ...
                                                <span class="avatar avatar-circle">
                                                    ...
                                                    @if($usr->send_by == 'client')
                                                    <img class="avatar-img" src="{{ userProfile($usr->created_by,'t') }}" alt="Image Description">
                                                    @else
                                                    <img class="avatar-img" src="{{ professionalProfile($usr->created_by,'t',$chat->subdomain) }}" alt="Image Description">
                                                    @endif
                                                    </a>
                                                </span>
                                                @endforeach
                        ...
                        ?>
                        <!-- Card -->
                        <div class="card  mb-2 chat-general-message {{ ($chat->chat_client_id == $messages[0]['chat_client_id'])?'bg-active':'' }}" data-name="{{$uname}}>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-circle">
                                            @if($chat->send_by == 'client')
                                            <img data-toggle="tooltip" data-placement="top" title="{{ $user->first_name.' '.$user->last_name }}" class="avatar-img" src="{{ userProfile($chat->created_by,'t') }}" alt="Image Description">
                                            @else
                                            <img data-toggle="tooltip" data-placement="top" title="{{ $user->first_name.' '.$user->last_name }}" class="avatar-img" src="{{ professionalProfile($chat->created_by,'t',$chat->subdomain) }}" alt="Image Description">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col" style="padding:0"> <span
                                            class="text-muted extra-small ms-2 chat-last-time">{{ dateFormat($chat->created_at,'F d,Y H:i:s') }}</span>
                                        <div class="d-flex align-items-center mb-2">
                                        <a href="{{ baseUrl('/messages-center/general-chats') }}?professional={{$chat->subdomain}}">
                                            <h5 class="me-auto mb-0">{{$user->first_name." ".$user->last_name}} ({{$user->role}})</h5>
                                        </a>
                        ...
                        ?>
                        <!-- Card -->
                        <div class="card  mb-2 chat-panel-message {{ ($chat->case_id == $messages[0]['case_id'])?'bg-active':'' }}" data-name="{{$uname}}>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-circle">
                                    ...
                                    <div class="col" style="padding:0"> <span
                                            class="text-muted extra-small ms-2 chat-last-time">{{ dateFormat($chat->created_at,'F d,Y H:i:s') }}</span>
                                        <div class="d-flex align-items-center mb-2">
                                        <a href="{{ baseUrl('/messages-center/case-chats') }}?case_id={{$chat->case_id}}&professional={{$chat->subdomain}}">
                                            <h5 class="me-auto mb-0">{{$user->first_name." ".$user->last_name}} ({{$user->role}})</h5>
                                        </a>
                                        </div>
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="avatar-group avatar-group-sm mb-1">
                                            ...
                                            <span class="avatar avatar-circle">
                                                ...
                                                <img class="avatar-img" src="{{ userProfile($usr->created_by,'t') }}" alt="Image Description">
                                                @else
                                                <img class="avatar-img" src="{{ professionalProfile($usr->created_by,'t',$usr->subdomain) }}" alt="Image Description">
                                                @endif
                                                </a>
                                            </span>
                                            @endforeach
                        ...
                        ?>
                        <div class="card  mb-2 chat-document-message {{ ($chat->document_id == $messages[0]['document_id'])?'bg-active':'' }}" data-name="{{$uname}}">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                            <div class="avatar avatar-circle">
                                        ...
                                        <div class="col" style="padding:0"> <span
                                                class="text-muted extra-small ms-2 chat-last-time">{{ dateFormat($chat->created_at,'F d,Y H:i:s') }}</span>
                                            <div class="d-flex align-items-center mb-2">
                                            <a href="{{ baseUrl('/messages-center/document-chats') }}?document_id={{$chat->document_id}}&professional={{$chat->subdomain}}">
                                                <h5 class="me-auto mb-0">{{$user->first_name." ".$user->last_name}} ({{$user->role}})</h5>
                                            </a>
                                            </div>
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="avatar-group avatar-group-sm mb-1">
                                            @foreach($chat_users as $usr)
                                                <?php
                                                if($usr->send_by != 'client'){
                                                    $cuser = docChatSendBy($usr->send_by,$usr->created_by,$usr->subdomain);
                                                }else{
                                                    $cuser = docChatSendBy($usr->send_by,$usr->created_by);   
                                                }
                                                ?>
                ...
                <div class="col-12 col-lg-7 col-xl-7">
                    <div class="py-2 px-4 border-bottom d-none d-lg-block" style="background: #fff;">
                        <div class="d-flex align-items-center py-1">
                            ...
                            <div class="flex-grow-1 pl-3">
                                ...
                                <?php 
                                if(!empty($messages)){
                                    $pchat_users = $messages[0]['chat_users'];
                                ...
                                @endif
                                @if(!empty($professional))
                                <div class="text-muted small"><em>{{$professional->company_name}}</em></div>
                                @endif
                            </div>
                            <div>
                                <!-- Avatar Group -->
                                ...
                                @foreach($pchat_users as $usr)
                                    ...
                                    $usr = (object)$usr;
                                    if($usr->send_by != 'client'){
                                        $cuser = docChatSendBy($usr->send_by,$usr->created_by,$messages[0]['subdomain']);
                                    }else{
                                        $cuser = docChatSendBy($usr->send_by,$usr->created_by);   
                                    }
                                    ?>
                                    <span class="avatar avatar-circle">
                                        ...
                                        <img class="avatar-img" src="{{ userProfile($usr->created_by,'t') }}" alt="Image Description">
                                        @else
                                        <img class="avatar-img" src="{{ professionalProfile($usr->created_by,'t',$messages[0]['subdomain']) }}" alt="Image Description">
                                        @endif
                                        </a>
                                    </span>
                                    @endforeach
                                    ...
                                    <div class="chat-main-sidebar-contents">
                                        <div class="chat-main-sidebar-actions display-flex justify-space-between">
                                            ...
                                            <?php 
                                                ...
                                                $user = docChatSendBy($message->send_by,$message->created_by,$message->subdomain);
                                                }else{
                                            ...
                                            <div class="message-blue-wrap mb-5 mt-3">
                                                ...
                                                <?php
                                                    $file_url = professionalDirUrl($chat->subdomain)."/documents/".$message->file_detail['file_name'];
                                                ?>
                                                <a href="{{$file_url}}" class="d-flex" download>
                                                <?php 
                                                    $fileicon = fileIcon($message->file_detail['original_name']);
                                                    echo $fileicon;
                                                ?>
                                                <div class="text-msg text-dark">{{$message->file_detail['original_name']}}</div>
                                                ...
                                                <span class="avatar avatar-xs avatar-circle">
                                                    @if($message->send_by == 'client')
                                                    <img class="avatar-img" src="{{ userProfile($message->created_by,'t') }}" alt="Image Description">
                                                    @else
                                                    <img class="avatar-img" src="{{ professionalProfile($message->created_by,'t',$message->subdomain) }}" alt="Image Description">
                                                    @endif
                                                </span>
                                            </div>
                                            @else
                                            <div class="message-orange-wrap  mb-5 mt-3">
                                                <div class="message-orange w-90">
                                                    ...
                                                    <?php 
                                                        ...
                                                        echo $fileicon;
                                                    ?>
                                                    <div class="text-msg text-dark d-block">{{$message->file_detail['original_name']}}</div><br>
                                                    <div class="text-white d-block">{{$message->file_message}}</div>
                                                    </a>
                                                    @else
                                                    <p class="message-content">
                    ...
                    <div class="flex-grow-0 py-3 px-4 border-top" style="background: #fff;">
                        <form id="send_chat_form" method="post">
                            {{csrf_field()}}
                            <div class="input-group">
                                <input type="hidden" id="professional" name="subdomain" class="cht_field" value="{{ $subdomain }}">
                                ...
                                @if($message_type == 'case_chats')
                                <input type="hidden" id="case_id" class="cht_field" name="case_id" value="{{ (!empty($messages))?$messages[0]['case_id']:   '' }}">
                                <input type="hidden" id="client_id" class="cht_field" name="client_id" value="{{ (!empty($messages))?$messages[0]['chat_client_id']:'' }}">
                                @endif
                                @if($message_type == 'general_chats')
                                ...
                                @if($message_type == 'document_chats')
                                <input type="hidden" id="case_id" class="cht_field" name="case_id" value="{{ (!empty($messages))?$messages[0]['case_id']:'' }}">
                                <input type="hidden" id="document_id" class="cht_field" name="document_id" value="{{ (!empty($messages))?$messages[0]['document_id']:'' }}">
                                @endif
