        ...
        <table id="tableList" class="table table-borderless">
          <thead class="thead-light">
            <tr>
              ...
              <th scope="col" class="table-column-pl-0">Vise Service</th>
              <th scope="col" class="table-column-pl-0">Date Posted</th>
...
function loadData(page=1){
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/eligibility-check/ajax-history?page='+page,
        data:{
            _token:csrf_token,
            search:search
        },
