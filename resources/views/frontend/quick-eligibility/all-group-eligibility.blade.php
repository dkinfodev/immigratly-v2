...
<ol class="breadcrumb breadcrumb-no-gutter">
  ...
  <a class="breadcrumb-link" href="{{ baseUrl('/eligibility-check') }}">Eligibility Check</a></li>
...
<a class="btn btn-primary btn-sm" href="{{ baseUrl('/eligibility-check') }}">
    Back
</a>
@endsection
...
function loadData(page){
    $.ajax({
        type: "GET",
        url: BASEURL + '/quick-eligibility/group-eligibility-form?page='+page,
        data:{
            next_page:page
        },
        dataType:'json',
...
function conditionalQuestion(e, ele) {
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/quick-eligibility/fetch-group-conditional',
        data: {
            _token: csrf_token,
