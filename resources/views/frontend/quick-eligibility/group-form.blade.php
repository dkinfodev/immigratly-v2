<form data-id="{{$visa_service_id}}" id="form-{{$visa_service_id}}" action="{{ baseUrl('/quick-eligibility/g/'.$visa_service_id) }}" class="mt-3">
    @if($action == 'multiple')
...
action="{{ baseUrl('/quick-eligibility/g/'.$visa_service_id) }}" class="mt-3">
@csrf
