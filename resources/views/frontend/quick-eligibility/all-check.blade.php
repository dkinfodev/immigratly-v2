...
<ol class="breadcrumb breadcrumb-no-gutter">
  ...
  <a class="breadcrumb-link" href="{{ baseUrl('/visa-services') }}">Visa Services</a></li>
...
function loadData(page=1){
    $.ajax({
        type: "GET",
        url: BASEURL + '/quick-eligibility/eligibility-form?page='+page,
        data:{
            next_page:page
        },
        dataType:'json',
...
function conditionalQuestion(question_id, e, ele) {
    ...
    $.ajax({
        type: "POST",
        url: BASEURL + '/quick-eligibility/fetch-conditional',
        data: {
            _token: csrf_token,
