  ...
  <div class="page-header">
    <div class="row align-items-end">
      ...
      <div class="col-sm-auto">
        <a class="btn btn-secondary" href="{{ baseUrl('/quick-eligibility/all-group-eligibility') }}">
          Check all Group Eligibility
        </a>
        <!--<a class="btn btn-secondary" href="{{ baseUrl('/quick-eligibility/all-eligibility') }}">-->
        <!--  Check all Eligibility-->
        <!--</a>-->
        <!--<a class="btn btn-primary" href="{{ baseUrl('/quick-eligibility/add') }}">-->
