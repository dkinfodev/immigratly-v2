...
<div class="">
        ...
        <div class="col-sm-12">
            <div class="text-center">
                ...
                <div class="mb-4">
                    ...
                    @endif
                    <div class="mt-3">
                        <a href="{{ baseUrl('quick-eligibility/download-report/'.base64_encode($record->id)) }}" class="btn btn-primary"><i class="tio-download"></i> Download Report</a>
                    </div>
                </div>
            </div>
            <?php
    ...
    @else
        ...
        <div class="mt-5">
        <h3>Other Dependent Services Report</h3>
        @foreach($dependent_response as $dep_response)
        <div class="card mt-4">
            <div class="card-header pt-2 pb-2">
                <h4>
                    {{ $dep_response['service_name'] }}
                </h4>
            </div>
            <?php 
                $questions_score = $dep_response['questions_score'];
            ?>
            <div class="card-body pt-2">
                <table class="table table-bordered">
                    ...
                    <tbody>
                @foreach($questions_score as $ques_score)
                    <tr>
                        <td>{{$ques_score['question']}}</td>
                        <td>{{$ques_score['option_value']}} ({{$ques_score['option_score']}})</td>
                    </tr>    
                @endforeach
                    </tbody>
                </table>
