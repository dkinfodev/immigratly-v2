...
@foreach($records as $record)
  <div class="col-12 p-2 mb-5">
      <!-- Card -->
      <div class="card card-bordered h-100 imm-all-program-list p-3">
          <!-- Card Body -->
              ...
              <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-9">
                      <h4 class="card-title mb-2">
                          <a class="text-dark" href="{{ baseUrl('quick-eligibility/lists/'.$record->unique_id) }}">{{$record->group_title}}</a>
                      </h4>
                      <div class="imm-self-assessment-container">
                          <div class="row">
                              ...
                              <div class="col-3">
                                  <a href="{{ baseUrl('quick-eligibility/lists/'.$record->unique_id) }}"
